          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div ref={ctaLeft.ref} style={ctaLeft.style}>
              ...
              <p className="text-white/50 text-sm leading-relaxed mb-10">
                Email marketing retainers start at ₹39,999/month. We'll audit
            ...
            >
              ...
              <ul className="space-y-4 mb-8">
                {[
                  "List Audit & Segmentation Map",
                  "Welcome Series (5–7 emails)",
                  "Monthly Broadcast Calendar",
                  ...
                  <li key={item} className="flex items-center gap-3 text-sm text-white/70">
                    <span
                      ...
                      style={{ backgroundColor: "#E8456A", color: "white" }}
                    >
                      ✓
                    </span>
                    {item}
              ...
              <div className="border-t border-white/10 pt-6 flex items-end justify-between">
                ...
                <p className="text-white/30 text-xs">All-inclusive</p>
              </div>
            </div>
          </div>
        </Container>
